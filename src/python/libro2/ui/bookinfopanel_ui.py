...
class Ui_BookInfoPanel(object):
    def setupUi(self, BookInfoPanel):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/expanded_16px.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.toolButton = QtWidgets.QToolButton(self.widgetMain)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/right_14px.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
