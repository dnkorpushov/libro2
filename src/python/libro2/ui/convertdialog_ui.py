...
class Ui_ConvertDialog(object):
    def setupUi(self, ConvertDialog):
        ...
        self.btnEditConfig.clicked.connect(ConvertDialog.onEditConfig) # type: ignore
        self.btnDowloadConverter.clicked.connect(ConvertDialog.onDownloadConverter) # type: ignore
    ...
    def retranslateUi(self, ConvertDialog):
        ...
        self.btnEditConfig.setText(_translate("ConvertDialog", "Edit config file"))
        self.btnDowloadConverter.setText(_translate("ConvertDialog", "Download fb2converter"))
