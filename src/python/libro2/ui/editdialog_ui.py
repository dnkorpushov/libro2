...
class Ui_EditDialog(object):
    def setupUi(self, EditDialog):
        ...
        self.btnAddGenre = QtWidgets.QPushButton(self.tab)
        self.btnAddGenre.setObjectName("btnAddGenre")
        self.gridLayout.addWidget(self.btnAddGenre, 4, 2, 1, 1)
        ...
        self.textTags = QtWidgets.QLineEdit(self.tab)
        ...
        self.btnLoadFromFile.clicked.connect(EditDialog.onBtnLoadClick) # type: ignore
        self.btnSaveToFile.clicked.connect(EditDialog.onBtnSaveClick) # type: ignore
    ...
    def retranslateUi(self, EditDialog):
        ...
        self.btnAddGenre.setText(_translate("EditDialog", "Add"))
