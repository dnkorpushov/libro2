...
class Ui_RenameDialog(object):
    def setupUi(self, RenameDialog):
        ...
        self.toolAuthor.setIcon(icon)
        self.toolAuthor.setIconSize(QtCore.QSize(18, 18))
        ...
        self.toolFilename.setIcon(icon)
        self.toolFilename.setIconSize(QtCore.QSize(18, 18))
